(function() {
  ...
  var questions = [
    ...
    type: 'input',
    name: 'vpc_subnet_id',
    message: 'What VPC Subnet ID would you like to use? (E.g., vpc-6de3570a)',
    validate: function(value){
      var regex = regexes.vpc;
      var errorMessage = 'The VPC ID must begin with \"vpc-\" and must end with exactly eight lowercase, alphanumeric characters.'
      return validateInput(value, regex, errorMessage);
    }
  },
